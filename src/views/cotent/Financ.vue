            ...
            <el-table
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <el-button @click="handleClick(scope.row)" type="text" size="small"><i class="iconfont iconguanli7" style="color: rgb(255,180,0);font-size: 0.22rem"></i> <span style="color: #333333">管理</span></el-button>
                    </template>
                </el-table-column>
            </el-table>
